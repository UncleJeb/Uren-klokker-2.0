<table class="table u-full-width table-custom">
    ...
    <tbody>
        ...
        <tr>
            ...
            <td><a class="btn" onclick="return confirm('Are you sure you want to delete this item')" href="<?php directoryCheck() ?>/Uren-klokker-2.0/assets/inc/uren-klokker/delete_entry.php?id=<?php echo $row["id"]?>">Delete</a></td>
        </tr>
        <?php } ?>
    </tbody>
    <thead>
